...
export default function Footer() {
  return (
    <div className="mt-auto">
      <footer className="footer items-center p-4 bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] text-black">
        ...
        <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a href="https://github.com/EricLin0619/BeePoll" target="_blank" rel="noreferrer">
            <FaGithub className='w-10 h-auto mr-1 text-black'/>
          </a>
        </div>  
      </footer>
    </div>
