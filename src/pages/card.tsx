...
export default function Page() {
  return (
    <div className="flex justify-center my-10">
      <div className="card p-4 w-3/5 h-auto bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] text-[#2E1503] ">
        <div className="card-body">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <div>
              ...
              <div className="flex items-center">
                <FaGithub className='w-10 h-auto text-black'/>
                <FaDiscord className='w-10 h-auto ml-4 text-black'/>
              </div>
            </div>
          </div>
          <div>
